 ...
 * 2013-12-19T22:45:03.572+01:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "KundeService", 
                  wsdlLocation = "file:/C:/git/camel/camelInaBox/src/main/resources/wsdl/kundeservice/KundeService_1.wsdl",
...
public class KundeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/git/camel/camelInaBox/src/main/resources/wsdl/kundeservice/KundeService_1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(KundeService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/git/camel/camelInaBox/src/main/resources/wsdl/kundeservice/KundeService_1.wsdl");
        }
        WSDL_LOCATION = url;
    }
